...
Used as a relatable "does the model still get it right?" pass-rate as quantization
drops. Grader extracts the last integer in the reply and compares to `answer`.
The harness 12-prompt suite is used separately for speed + greedy output-drift.
"""
GRADED = [
    {"id": "g1", "answer": 23,
