"""Bundle your quantization-sweep results + hardware into a community submission.

    python scripts/make_submission.py --name "rtx4090"

Writes results/community/<name>.json (your results.json under runs.sweep + hardware).
