"""Bundle your CPU thread-scaling results + hardware into a community submission.

    python scripts/make_submission.py --name "my-cpu-label"

Writes results/community/<name>.json (your results.json under runs.threads + hardware).
...
def main():
    ...
    sub = {"name": args.name, "notes": args.notes,
           ...
           "runs": {"threads": json.load(open(res, encoding="utf-8-sig"))}}
