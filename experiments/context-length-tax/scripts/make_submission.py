"""Bundle your context-length sweep results + hardware into a community submission.

    python scripts/make_submission.py --name "rtx5060ti"

Writes results/community/<name>.json (your results.json under runs.context + hardware).
...
def main():
    ...
    sub = {"name": args.name, "notes": args.notes,
           ...
           "runs": {"context": json.load(open(res, encoding="utf-8-sig"))}}
