"""Bundle your model-size-sweep results + hardware into a community submission.

    python scripts/make_submission.py --name "rtx4090"

Writes results/community/<name>.json (your results.json under runs.models + hardware).
...
def main():
    ...
    sub = {"name": args.name, "notes": args.notes,
           ...
           "runs": {"models": json.load(open(res, encoding="utf-8-sig"))}}
