"""Bundle your runner-showdown results + hardware into a community submission.

    python scripts/make_submission.py --name "rtx4090-ryzen7950x"

Writes results/community/<name>.json (your results.json under runs.showdown +
hardware info). Open a PR adding that file.
"""
...
def main():
    ...
    sub = {"name": args.name, "notes": args.notes,
           ...
           "runs": {"showdown": json.load(open(res, encoding="utf-8-sig"))}}
