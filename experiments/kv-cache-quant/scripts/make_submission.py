"""Bundle your KV-cache sweep results + hardware into a community submission.

    python scripts/make_submission.py --name "rtx5090"

Writes results/community/<name>.json (your results.json under runs.kvcache + hardware).
...
def main():
    ...
    sub = {"name": args.name, "notes": args.notes,
           ...
           "runs": {"kvcache": json.load(open(res, encoding="utf-8-sig"))}}
