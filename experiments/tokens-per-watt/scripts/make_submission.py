"""Bundle your power-sweep results + hardware into a community submission.

    python scripts/make_submission.py --name "rtx4090"

Writes results/community/<name>.json (your results.json under runs.power + hardware).
...
def main():
    ...
    sub = {"name": args.name, "notes": args.notes,
           ...
           "runs": {"power": json.load(open(res, encoding="utf-8-sig"))}}
