"""Bundle your vram-offload-cliff results + hardware into a community submission.

    python scripts/make_submission.py --name "rtx4090"

Writes results/community/<name>.json (your results.json under runs.offload + hardware).
...
def main():
    ...
    sub = {"name": args.name, "notes": args.notes,
           ...
           "runs": {"offload": json.load(open(res, encoding="utf-8-sig"))}}
